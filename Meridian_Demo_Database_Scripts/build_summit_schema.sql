...
REM If this fails with ORA-01940 because c##meridian user is connected, issue the following as system:

REM alter system kill session '<SID>,<SERIAL#>' immediate;

REM Modify the next line to point to your database SID if not local (connect C##meridian/meridian@SID)

connect C##meridian/meridian
@@create_tables
@@create_sequences
@@create_functions
@@create_packages
